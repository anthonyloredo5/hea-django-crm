...
STATIC_URL = "/static/"
STATICFILES_DIRS = [os.path.join(BASE_DIR, "react-crm-frontend/build/static")]

REACT_APP_BUILD_PATH = "react-crm-frontend/build"
...
CSRF_TRUSTED_ORIGINS = ["https://ec2-44-204-70-185.compute-1.amazonaws.com", "http://*"]
